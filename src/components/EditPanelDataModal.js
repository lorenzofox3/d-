import {h} from 'flaco';
import {
  CreateSmartListDataPanel,
  CreateSmartChartDataPanel,
  CreateSmartAggregationDataPanel
} from '../views/EditDataPanelForm';
...
export const CreateSmartAggregationModal = CreateDataPanel(CreateSmartAggregationDataPanel, {
  type: 'aggregation',
  showToolBar: true
});
